...
public class FileNode {
    /**
     * Relative path of the file or directory from repository root
     */
    @Getter
     ...
     * @throws IllegalStateException if this is a file node
     */
    ...
    /**
     * Check if this node represents a source code file
     *
     * @return true if this is a source code file
     */
    ...
    /**
     * Check if this node represents a configuration file
     *
     * @return true if this is a configuration file
     */
    ...
    /**
     * Check if this node represents a documentation file
     *
     * @return true if this is a documentation file
     */
    public boolean isDocumentation() {
        ...
        return name.equals("readme.md") ||
                ...
                name.equals("license") ||
                name.equals("license.md") ||
                name.equals("license.txt") ||
                ext.equals("md") ||
                ext.equals("txt") ||
                path.toLowerCase().contains("doc/") ||
                path.toLowerCase().contains("docs/");
    }

    /**
     * Get the depth of this node in the tree (0 = root)
     *
     * @return Depth in the tree
     */
    public int getDepth() {
        if (parent == null) {
            return 0;
